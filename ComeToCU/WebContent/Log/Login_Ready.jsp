...
<body>
	...
	<div class="modal-header">
		<!-- 닫기(x) 버튼 -->
		<button type="button" onclick="end()" class="close" data-dismiss="modal">×</button>
		<!-- header title -->
		...
		<form action="/Log/LoginProcess.jsp" method="POST">
						...
						<div class="input-group">
							...
							<span class="input-group-addon" id="S_Num">학번</span> <input
								...
								required autofocus onkeypress="return digit_check(event)" maxlength="8" >
						</div>
						...
						<br/>
						<button class="btn btn-default btn-info btn-block" 
